...
const ProjectCta = () => {
    return (
        <>
            <figure className="position-absolute start-0 bottom-0 ms-n6 mb-n4 z-index-9 d-none d-lg-block">
                <svg width="285" height="82" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 285 82">
                    <rect className="fill-primary" x="22.67" y="16.58" width="262.22" height="65.42"/>
            ...
            <div className="container">
                <div className="row g-0 d-flex align-items-center">
                    <div className="col-sm-6">
                        <div className="text-center bg-primary-multiply position-relative overflow-hidden px-3 py-6 h-100" >
                            <h2 className="mb-3 display-6"><a className="text-white-stroke" href="#">Our Work</a></h2>
                            <a className="btn btn-line text-white mb-0" href="#">View projects</a>
                            <img className="bg-primary-multiply position-absolute top-50 start-50 translate-middle z-index-n9"
                                 src="/images/about/05.jpg" alt="" />
                        </div>
                    </div>
                    <div className="col-sm-6">
                        <div className="text-center bg-dark px-3 py-6 h-100">
                            <h2 className="mb-3 display-6 text-white">Have a Project?</h2>
                            <a className="btn btn-line text-white mb-0" href="#">Get a Quote</a>
                        </div>
                    </div>
                </div>
            </div>
