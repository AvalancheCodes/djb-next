          ...
          <div className="col-sm-6">
            <div className="text-center bg-primary-multiply position-relative overflow-hidden px-3 py-6 h-100">
              <h2 className="mb-3 display-6">
                <a className="text-white-stroke" href="#">
                  Our Work
                </a>
              </h2>
              <a className="btn btn-line text-white mb-0" href="#">
                View projects
              </a>
              <img
                className="bg-primary-multiply position-absolute top-50 start-50 translate-middle z-index-n9"
