...
const DottedRectangle = ( { classList } ) => {
  return (
        ...
        <figure className={classList}>
            <svg width="211" height="102" viewBox="0 0 172 83" xmlns="http://www.w3.org/2000/svg">
                <path className="stroke-primary stroke-10 fill-none"
                ...
                <circle className="stroke-primary stroke-10 fill-none" cx="95.03" cy="76.66" r="3.34" />
                <path className="stroke-primary stroke-10 fill-none"
                ...
                <circle className="stroke-primary stroke-10 fill-none" cx="23.87" cy="76.66" r="3.34" />
                <circle className="stroke-primary stroke-10 fill-none" cx="6.08" cy="76.66" r="3.34" />
                <path className="stroke-primary stroke-10 fill-none"
                ...
                <circle className="stroke-primary stroke-10 fill-none" cx="95.03" cy="58.92" r="3.34" />
                <path className="stroke-primary stroke-10 fill-none"
                ...
                <circle className="stroke-primary stroke-10 fill-none" cx="23.87" cy="58.92" r="3.34" />
                <circle className="stroke-primary stroke-10 fill-none" cx="6.08" cy="58.92" r="3.34" />
                <path className="stroke-primary stroke-10 fill-none"
                ...
                <circle className="stroke-primary stroke-10 fill-none" cx="95.03" cy="41.18" r="3.34" />
                <path className="stroke-primary stroke-10 fill-none"
                ...
                <circle className="stroke-primary stroke-10 fill-none" cx="23.87" cy="41.18" r="3.34" />
                <circle className="stroke-primary stroke-10 fill-none" cx="6.08" cy="41.18" r="3.34" />
                <path className="stroke-primary stroke-10 fill-none"
                ...
                <ellipse className="stroke-primary stroke-10 fill-none"
                         transform="matrix(.036 -.9994 .9994 .036 85.908 100.46)" cx="95.03" cy="5.7"
                         rx="3.34" ry="3.34" />
                <path className="stroke-primary stroke-10 fill-none"
                ...
                <ellipse className="stroke-primary stroke-10 fill-none"
                         transform="matrix(.0333 -.9994 .9994 .0333 17.374 29.364)" cx="23.87" cy="5.7"
                         rx="3.34" ry="3.34" />
                <ellipse className="stroke-primary stroke-10 fill-none"
                         transform="matrix(.0333 -.9994 .9994 .0333 .1775 11.584)" cx="6.08" cy="5.7"
                         rx="3.34" ry="3.34" />
            </svg>
        </figure>
  );
