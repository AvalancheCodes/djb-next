...
const ServicesHero: FC = () => {
  ...
  return (
    <section
      className="bg-white pattern-overlay-3 pt-0 position-relative h-400
        ...
        <div className="row">
          <div className="col-lg-8 position-absolute start-0 top-0 text-start mt-5 mt-md-9 z-index-99">
            <h1 className="display-4 text-dark">
              <span className="text-dark-stroke text-primary-shadow">
                This is how I roll
              </span>{" "}
              your business online
            </h1>
            <a href="#" className="btn btn-dark btn-line">
